    ...
    <div class="card-body">
        <form>
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <div class="custom-control custom-radio custom-control-inline">
                        <input class="custom-control-input" type="radio" name="title" id="title1" value="นาย" check>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <div class="custom-control custom-radio custom-control-inline">
                        <input class="custom-control-input" type="radio" name="academic_pos" id="academic_pos1" value="ศ." check>
                    ...
                    <div class="custom-control custom-radio custom-control-inline">
                        <input class="custom-control-input" type="radio" name="academic_pos" id="academic_pos4" value="อื่นๆ" checked>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <div class="custom-control custom-radio custom-control-inline">
                        <input class="custom-control-input" type="radio" name="gender" id="gender1" value="ชาย" check>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <div class="custom-control custom-radio custom-control-inline">
                        <input class="custom-control-input" type="radio" name="bursary" id="bursary1" value="1" check>
...
<br/>
<!-- work experience  ตั้งแต่ตรงนี้ตรงนี้ยังไม่ validator และ ดาต้าเบส-->
<div class="card">
    <div class="card-header">
        ประวัติการทำงาน
    </div>
...
<div class="card">
    ...
    <div class="card-body">
        <div class="form-row">
            ...
            <div class="form-group col-md-6">
                <select name="sub_district_id" id="sub_district_id" value="{{ old('sub_district_id') }}">
                    <option value="">เกษตรและพัฒนาชนบท
                        </option/>
                </select>
            </div>
        </div>
        ...
        <div class="form-row">
            ...
            <div class="form-group col-md-6">
                <select name="sub_district_id" id="sub_district_id" value="{{ old('sub_district_id') }}">
                    <option value="">การวางแผนพัฒนาชนบท
                        </option/>
                </select>
            </div>
        </div>
        <div class="form-row">
            <label class="col-sm-2 col-form-label">เรื่องที่สนใจ</label>
            <div class="form-group col-md-6">
                <input type="text" class="form-control" id="id_card" name="id_card" placeholder="" required value="{{ old('id_card') }}">
            </div>
        </div>
